...
tb_5 <- dplyr::left_join(tb_4, wvs_psp_sub, by = c("cown", "cowc", "year"))
...
saveRDS(tb_6, paste0(here::here(), '/data/tjbrailey_psp_not_cleaned.rds'))

# Remove intermediate join files.
rm(tb, tb_1, tb_2, tb_3, tb_4, tb_5)
```
