---
title: "Provisions of Power-Sharing: Assessing the Impacts of Segmental Autonomy^[Political Stability and Minority Inclusion, MPSA 2021]"
...
- Whether power-sharing is a panacea, or "tautological" (\cite{andeweg_consociational_2000}).
...
- First, read papers to see how the authors discuss power-sharing, power-dividing, consociational democracy, etc. 

- Second, record what the "components" of power-sharing were. Mutual veto? Segmental autonomy? Truth commission? 
...
- Presents a roadmap for future analysis and cumulative findings (\cite{dunning_information_2020}). 
